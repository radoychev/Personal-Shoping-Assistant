    ...
    //  SmartAisle
    //
    //  Created by Nathan Pete on 05/08/2024.
    //
...
class ShoppingListManager: ObservableObject {
    ...
    func loadShoppingList() {
        ...
        userDocRef.addSnapshotListener { [weak self] documentSnapshot, error in
            ...
            guard let document = documentSnapshot, document.exists, let data = document.data(), let stringList = data["shoppingList"] as? [String] else {
