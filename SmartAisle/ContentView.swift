...
struct ContentView: View {
    ...
    // Inject ShoppingListManager as an environment object
                ...
                if isLoading && products.isEmpty {
                    ...
                    List {
                        ForEach(products) { product in
                            NavigationLink(destination: ProductDetailScreen(navigate: .constant(.search), product: product)
                                            .environmentObject(shoppingListManager)) { // Pass the environment object to ProductDetailScreen
                                HStack {
...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
        // Inject ShoppingListManager in the preview to avoid runtime errors
        ContentView()
